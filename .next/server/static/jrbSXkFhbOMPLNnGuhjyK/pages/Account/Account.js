...
/* harmony import */ var universal_cookie__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(33);
...
/* harmony import */ var _UserPool__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(13);
...
var AccountContext = react__WEBPACK_IMPORTED_MODULE_1___default.a.createContext();
...
function (_React$Component) {
  ...
  function Account() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getUser", function () {
      return _UserPool__WEBPACK_IMPORTED_MODULE_3__["default"].getCurrentUser();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "logout", function (requestLogin) {
      // Get the current logged in user
      var user = _this.getUser(); // Check if a user was actually logged in
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getSession",
    /*#__PURE__*/
    _asyncToGenerator(
    /*#__PURE__*/
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return new Promise(function (resolve, reject) {
                var user = _UserPool__WEBPACK_IMPORTED_MODULE_3__["default"].getCurrentUser();
                console.log("User:", user);

                if (user) {
                  user.getSession(function (err, session) {
                    var apiKey = new universal_cookie__WEBPACK_IMPORTED_MODULE_2___default.a().get("api-key");

                    if (err || !session.isValid() || !apiKey) {
                      _this.logout(redirect);
  ...
  _createClass(Account, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(AccountContext.Provider, {
        value: {
          logout: this.logout,
